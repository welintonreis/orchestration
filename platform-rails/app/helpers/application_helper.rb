module ApplicationHelper
  ...
  def nav_link(name, path, icon: nil, sidebar_open_expr: "sidebarOpen")
    ...
    active_cls = "bg-cyan-100 dark:bg-cyan-900/40 text-cyan-600 dark:text-cyan-400 border border-cyan-300 dark:border-cyan-800/60"
  ...
  SIDEBAR_ICONS = {
    vps:        %(<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M0 0h24v24H0z" fill="none" stroke="none"/><path stroke-linecap="round" stroke-linejoin="round" d="M4 5h16a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V6a1 1 0 011-1zm3 5l3 2.5L7 15m5 0h5"/></svg>),
    s3_storage: %(<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 5.625c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125"/></svg>),
    dns:        %(<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418"/></svg>),
    ...
    git_link:   %(<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M0 0h24v24H0z" fill="none" stroke="none"/><path stroke-linecap="round" stroke-linejoin="round" d="M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 01-5.656-5.656l1.5-1.5M10.172 13.828a4 4 0 010-5.656l3-3a4 4 0 015.656 5.656l-1.5 1.5"/></svg>),
    ...
    topology:   %(<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 16 16"><path d="M0 0h16v16H0z" fill="none"/><path fill="currentColor" d="M6.256 1.922A3.27 3.27 0 0 1 9.124 6.76l1.6 1.222a2.414 2.414 0 1 1-.533.746L8.575 7.495a3.26 3.26 0 0 1-3.179.85l-.662 1.706c.556.405.919 1.06.919 1.8a2.227 2.227 0 1 1-1.756-2.176l.657-1.692a3.27 3.27 0 0 1 1.702-6.06m-2.83 8.618a1.311 1.311 0 1 0 .001 2.622a1.311 1.311 0 0 0-.001-2.622m8.96-2.307a1.497 1.497 0 1 0 .002 2.995a1.497 1.497 0 0 0-.002-2.995M6.256 2.84a2.353 2.353 0 1 0 0 4.706a2.353 2.353 0 0 0 0-4.706"/></svg>),
    ...
    hud:         %(<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M21 4h-4a4 4 0 0 0-4 4v8a4 4 0 0 0 4 4h4"/><circle cx="17" cy="12" r="2.6"/></svg>),
