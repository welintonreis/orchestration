...
// Confirmação do Turbo (data-turbo-confirm) e dos x-on do Alpine pelo mesmo diálogo de dialogs.js.
Turbo.config.forms.confirm = (msg) => confirmDialog(msg)
Object.assign(window, { confirmDialog, promptDialog, alertDialog })
